...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    ...
    >
      <div className="relative pt-3 px-3 flex items-center justify-center h-32 sm:h-48 bg-gradient-to-br from-[#252525] to-[#202020]">
        ...
        <div className="absolute top-2 left-2">
          <span className="bg-center-orange text-white text-xs px-2 py-0.5 rounded-full font-medium">
            {product.code}
          </span>
        </div>
      </div>
      ...
      <div className="p-3 sm:p-4 flex flex-col flex-grow">
        <h3 className="font-medium text-white text-sm sm:text-base group-hover:text-center-orange transition-colors mb-2 sm:mb-4 line-clamp-2 h-8 sm:h-12">
          {displayName}
        </h3>
