    ...
    <section className="w-full bg-[#181818] pt-16 pb-8 md:pt-24 md:pb-14">
      <div className="container-custom">
        <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center">
          <div className="flex flex-col gap-2 md:gap-4 md:max-w-2xl">
            ...
            <div className="flex flex-wrap gap-2 md:gap-3 mt-1 md:mt-2">
              <Link 
                ...
                className="btn-primary flex items-center gap-1 text-xs md:text-base py-1.5 md:py-2.5 px-3 md:px-5"
              >
                Ver Produtos
              </Link>
              ...
              <Link 
                to="/categoria/ar-condicionado" 
                className="inline-flex items-center gap-1 px-3 md:px-5 py-1.5 md:py-2.5 text-white bg-[#252525] hover:bg-[#333333] rounded-md transition-colors text-xs md:text-base"
              >
                Faça seu pedido
            ...
            <div className="flex flex-wrap gap-3 md:gap-8 mt-4 md:mt-6">
              <div className="flex items-center gap-1.5">
                <div className="w-4 h-4 md:w-6 md:h-6 flex items-center justify-center bg-center-orange/20 text-center-orange rounded">
          ...
          <div className="md:w-2/5 rounded-lg overflow-hidden shadow-2xl mt-2 md:mt-0 h-auto" style={{minHeight: '200px', position: 'relative'}}>
            ...
            <img 
              ...
              className={`w-full h-auto object-cover rounded-lg ${isImageLoaded ? 'opacity-100' : 'opacity-0'} transition-opacity`}
              width="500"
              height="350"
              fetchPriority="high"
              style={{
