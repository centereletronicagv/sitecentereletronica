...
export default function Hero() {
  return (
    <section className="relative pt-24 pb-20 overflow-hidden bg-[#181818]">
      <div className="container-custom relative z-10">
        ...
        <div className="mt-16 pt-8 pb-12 px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#222222] rounded-xl p-6 shadow-sm border border-gray-800 flex flex-col items-center text-center h-full">
