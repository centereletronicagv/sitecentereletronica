...
<body>
  ...
  <div class="container">
    <h2>Atualizações dos seus amigos</h2>

    <div class="post">
      <img src="https://i.pravatar.cc/60?img=1" alt="Amigo 1">
      <div class="post-content">
        <h3>João Silva</h3>
        <p>Acabei de voltar de uma viagem incrível para o Rio de Janeiro!</p>
        <div class="post-time">há 2 horas</div>
      </div>
    </div>

    <div class="post">
      <img src="https://i.pravatar.cc/60?img=2" alt="Amigo 2">
      <div class="post-content">
        <h3>Maria Oliveira</h3>
        <p>Adorei a nova música da banda que o Lucas me mostrou 😍</p>
        <div class="post-time">há 5 horas</div>
      </div>
    </div>

    <div class="post">
      <img src="https://i.pravatar.cc/60?img=3" alt="Amigo 3">
      <div class="post-content">
        <h3>Carlos Mendes</h3>
        <p>Alguém lembra da época dos scraps? Bons tempos kkk</p>
        <div class="post-time">ontem</div>
      </div>
    </div>
