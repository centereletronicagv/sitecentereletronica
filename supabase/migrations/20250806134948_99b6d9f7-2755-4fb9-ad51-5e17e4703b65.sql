...
-- Inserir TODOS os produtos de todas as categorias
...
FROM (VALUES
  -- AR CONDICIONADO (96 produtos) - Suportes
  ...
  ('CABO PP 4 X 1,5mm', '9947', 0, '/lovable-uploads/pp4.png', 'ar-condicionado', 'Cabo PP 4 vias 1,5mm - Por Metro', true, false, 6),
  ('CABO PARALELO 2x2,5MM', '03856', 0, '/lovable-uploads/paralelo2x25mm.png', 'ar-condicionado', 'Cabo paralelo 2x2,5mm - Por Metro', true, false, 6),
  ('CABO PARALELO PRETO 2x2,5MM', '13320', 0, '/lovable-uploads/paralelopreto2x25mm.png', 'ar-condicionado', 'Cabo paralelo preto 2x2,5mm - Por Metro', true, false, 6),
  ('CABO PP 5 X 1,5mm', '8492', 0, '/lovable-uploads/pp5.png', 'ar-condicionado', 'Cabo PP 5 vias 1,5mm - Por Metro', true, false, 6),
  
  -- AUTOMAÇÃO (96 produtos) - Botões de Impulso
  ...
  ('BOTÃO DE IMPULSO DUPLO ILUM. 1NA+1NF 220V', '7891435936452', NULL, '/lovable-uploads/impulsoduplotramontina.png', 'automacao', 'Botão de impulso duplo iluminado 1NA+1NF para 220V', true, false, 7),
  ...
  -- INSTALAÇÕES ELÉTRICAS (45 produtos) - Disjuntores WEG Monopolar
  ...
  -- TERMINAIS (46 produtos) - Conectores WAGO
  ...
  ('CONECTOR PERFURANTE 4-6MM', '7898009454367', 0, '/lovable-uploads/perfuranteamarelo.png', 'terminais', 'Conector perfurante para cabos de 4-6mm', true, false, 7),
